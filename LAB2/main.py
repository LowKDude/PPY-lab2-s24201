...
with open("output.txt", "r") as file:
    ...
    num_integers = sum([1 for char in content if char.isdigit()])
    sum_integers = sum([int(num) for num in content.split() if num.isdigit()])

# Modify File Content
with open("output.txt", "a") as file:
    file.write("\n\n")
    file.write("Number of lines in the file: " + str(num_lines) + "\n")
    file.write("Number of integers in the file: " + str(num_integers) + "\n")
    file.write("Sum of all integers in the file: " + str(sum_integers) + "\n")
